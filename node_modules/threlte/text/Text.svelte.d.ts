...
declare const __propDef: {
    props: {
        ...
        viewportAware?: TextProperties['viewportAware'];
        inViewport?: TextProperties['inViewport'];
        ...
        interactive?: TextProperties['interactive'];
        ignorePointer?: TextProperties['ignorePointer'];
    ...
    events: {
        click: CustomEvent<import("../types/types").ThreltePointerEvent>;
        contextmenu: CustomEvent<import("../types/types").ThreltePointerEvent>;
        pointerup: CustomEvent<import("../types/types").ThreltePointerEvent>;
        pointerdown: CustomEvent<import("../types/types").ThreltePointerEvent>;
        pointerenter: CustomEvent<import("../types/types").ThreltePointerEvent>;
        pointerleave: CustomEvent<import("../types/types").ThreltePointerEvent>;
        pointermove: CustomEvent<import("../types/types").ThreltePointerEvent>;
