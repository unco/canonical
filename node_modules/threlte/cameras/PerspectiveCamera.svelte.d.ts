...
declare const __propDef: {
    props: {
        ...
        viewportAware?: PerspectiveCameraProperties['viewportAware'];
        inViewport?: PerspectiveCameraProperties['inViewport'];
        useCamera?: PerspectiveCameraProperties['useCamera'];
