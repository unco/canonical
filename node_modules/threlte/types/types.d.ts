...
import type { AudioListener, Camera, Clock, Color, ColorRepresentation, Euler, Event, Intersection, Loader, Material, Matrix4, Mesh, Object3D, Raycaster, Scene, Vector2, Vector3, WebGLRenderer } from 'three';
...
declare const createEventDispatcherType: () => <EventKey extends keyof ThreltePointerEventMap>(type: EventKey, detail?: ThreltePointerEventMap[EventKey]) => void;
