...
declare const __propDef: {
    props: {
        ...
        viewportAware?: LineProperties['viewportAware'];
        inViewport?: LineProperties['inViewport'];
        ...
        interactive?: LineProperties['interactive'];
        ignorePointer?: LineProperties['ignorePointer'];
        lookAt?: LineProperties['lookAt'];
        geometry?: LineProperties['geometry'];
        points?: LineProperties['points'];
        material: LineProperties['material'];
        line?: ThreeLine<BufferGeometry, import("three").Material | import("three").Material[]>;
    };
    events: {
