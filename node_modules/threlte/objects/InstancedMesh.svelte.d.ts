...
export declare const useInstancedMesh: (id: string) => InstancedMeshContext;
declare const __propDef: {
    props: {
        ...
        viewportAware?: InstancedMeshProperties['viewportAware'];
        inViewport?: InstancedMeshProperties['inViewport'];
        ...
        interactive?: InstancedMeshProperties['interactive'];
        ignorePointer?: InstancedMeshProperties['ignorePointer'];
        ...
        instancedMesh?: Writable<ThreeInstancedMesh>;
    };
    events: {
