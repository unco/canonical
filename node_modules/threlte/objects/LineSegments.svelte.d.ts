...
declare const __propDef: {
    props: {
        ...
        viewportAware?: LineSegmentsProperties['viewportAware'];
        inViewport?: LineSegmentsProperties['inViewport'];
        ...
        interactive?: LineSegmentsProperties['interactive'];
        ignorePointer?: LineSegmentsProperties['ignorePointer'];
        lookAt?: LineSegmentsProperties['lookAt'];
        geometry: LineSegmentsProperties['geometry'];
        material: LineSegmentsProperties['material'];
        lineSegments?: ThreeLineSegments<import("three").BufferGeometry, import("three").Material | import("three").Material[]>;
    };
    events: {
