...
declare const __propDef: {
    props: {
        ...
        viewportAware?: MeshProperties['viewportAware'];
        inViewport?: MeshProperties['inViewport'];
        ...
        interactive?: MeshProperties['interactive'];
        ignorePointer?: MeshProperties['ignorePointer'];
        lookAt?: MeshProperties['lookAt'];
        geometry: MeshProperties['geometry'];
        material: MeshProperties['material'];
        mesh?: ThreeMesh<import("three").BufferGeometry, import("three").Material | import("three").Material[]>;
    };
    events: {
