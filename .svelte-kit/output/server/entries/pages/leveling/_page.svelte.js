...
const css$1 = {
  code: ".stars.svelte-17v5sku.svelte-17v5sku{color:#ccc;text-align:center}.stars.svelte-17v5sku svg.svelte-17v5sku{margin:0 2px}.stars.align_left.svelte-17v5sku.svelte-17v5sku{text-align:left}.stars-1.svelte-17v5sku circle.svelte-17v5sku{fill:#D3481D }.stars-2.svelte-17v5sku circle.svelte-17v5sku{fill:#AF3B29}.stars-3.svelte-17v5sku circle.svelte-17v5sku{fill:#8D2F35}.stars-4.svelte-17v5sku circle.svelte-17v5sku{fill:#6A2240}.stars-5.svelte-17v5sku circle.svelte-17v5sku{fill:#4B1233}.stars-6.svelte-17v5sku circle.svelte-17v5sku{fill:#2C011E}",
  map: null
};
const Stars = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${levels2[level.level] ? `<div class="${[
    "stars stars-" + escape(stars, true) + " svelte-17v5sku",
    ...
    return `<svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-17v5sku"><circle cx="10" cy="10" r="9" class="svelte-17v5sku"></circle></svg>`;
  })}`}</div>` : ``}`;
});
